...
class OkulSistemineGiris {
     ...
     * 		     Bu class'ýn içine "ogretmenEkle(Ogretmen ogretmen)" diye bir method ekleyelim. Bunu kullanarak yeni öðretmen 
     * 			ekleyebilelim.
     *
     ...
     * 		     Bu class'ýn içine "ogrenciEkle(Ogrenci ogrenci)" diye bir method ekleyelim. Bunu kullanarak yeni öðrenci 
     * 			 ekleyebilelim.
     *
     *
     * */
